...
*/
CREATE TABLE [Result_Table_KNN_Prediction3](
	[ID] INT NOT NULL,
...
BEGIN   
       ...
       */
		...
		*/
		...
		FROM MMN_Train_Set
		WHERE (service = @service) AND (protocol_type = @protocol_type)
		...
		*/
		...
		BEGIN
			...
			INSERT INTO Result_Table_KNN_Prediction3(ID, isAttack, isAttackPrediction, attackGroup, attackGroupPrediction)
